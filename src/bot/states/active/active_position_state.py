...
class ActivePositionState(PositionState):
    ...
    def __init__(
        self,
        parent: Any,
        previous_state: FlatPositionState,
        ...
        self.previous_state: FlatPositionState = previous_state
    ...
    def _close_position(
        ...
        if not self.previous_state.is_pending:
            Logger.log_info(
                "TP: "
    ...
    def _handle_tp(
        ...
        self.parent.state = self.previous_state._set_tp_state()
    ...
    def _handle_sl(
        ...
        self.parent.state = self.previous_state._set_sl_state()
